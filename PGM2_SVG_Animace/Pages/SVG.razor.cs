using PGM2_SVG_Animace.Models;
using System.Drawing;

namespace PGM2_SVG_Animace.Pages
{
        ...
        private void PridatObrazec(Microsoft.AspNetCore.Components.Web.MouseEventArgs e)
        {
            ...
            switch (typ) 
            {
                ...
                case Globals.TypObrazce.obdelnik:
                    ...
                    obrazec = new Obdelnik(typ, random.Next(0, SvgWidth - rozmer1), random.Next(0, SvgHeight - rozmer2), barva, rozmer1, rozmer2);
                    break;
